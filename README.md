...
[![Build Status](https://travis-ci.org/sananguliyev/go-shopify.svg?branch=master)](https://travis-ci.org/sananguliyev/go-shopify)
[![codecov](https://codecov.io/gh/sananguliyev/go-shopify/branch/master/graph/badge.svg)](https://codecov.io/gh/sananguliyev/go-shopify) [![Join the chat at https://gitter.im/sananguliyev/go-shopify](https://badges.gitter.im/sananguliyev/go-shopify.svg)](https://gitter.im/sananguliyev/go-shopify?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
```console
$ go get github.com/sananguliyev/go-shopify
```

## Use

```go
import "github.com/sananguliyev/go-shopify"
```
...
pass in the built in options or create your own and manipulate the client. See [options.go](https://github.com/sananguliyev/go-shopify/blob/master/options.go)
for more details.
